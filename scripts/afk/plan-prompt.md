...
For each unblocked issue, assign a branch name using the format `afk/issue-{number}`. The branch name is fully determined by the issue number — do not append a slug.
...
<plan>
{"issues": [{"number": 42, "title": "Fix auth bug", "branch": "afk/issue-42"}]}
</plan>
