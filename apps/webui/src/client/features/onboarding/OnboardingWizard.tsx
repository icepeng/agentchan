...
import { useOnboarding, type OnboardingStep } from "./useOnboarding.js";

const STEPS: OnboardingStep[] = [0, 1];
...
export function OnboardingWizard() {
  ...
  return (
    <Dialog open={ob.wizardOpen} onOpenChange={() => void ob.dismiss()} modal={false}>
  ...
  return (
    <div className="w-full animate-fade">
      ...
      <div className="flex items-center justify-center gap-4 mt-8">
        {hasAnyKey ? (
          <Button variant="accent" size="md" onClick={onComplete}>
