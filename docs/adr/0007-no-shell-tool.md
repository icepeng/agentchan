...
Motivation: Agentchan은 end-user app으로 배포된다. 일반 shell Tool은 OS별 shell 차이와 설치 상태를 Creative agent 실행 계약에 끌어들이고, Windows User나 packaged executable에서 Template helper script 실행을 불안정하게 만든다.
