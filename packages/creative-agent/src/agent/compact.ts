 ...
 *
 * fullCompact — LLM-based creative conversation summarization for session
 * compaction entries.
 */
...
This summary will be used as a compaction summary to preserve context for continuing the same creative session. Summarize thoroughly so that someone reading only your summary can fully understand what happened and continue the creative work.
